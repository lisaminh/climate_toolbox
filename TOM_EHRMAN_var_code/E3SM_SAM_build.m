function [SAM,lat_use,lon_use,Use] = E3SM_SAM_build(Dates,file_base,years,output_dir,year1)
% This is the function builds the SAM index
...
Z = zeros(NN,TT);
Z_temp = read_E3SM_QOI(file_base,h_num,Dates(f_start,:),'Z700',[1 t_start],[Inf Inf]);
Z(:,1:t1) = Z_temp(Use,:);
...
file_out = strcat(output_dir,'/SAM.nc');

nccreate(file_out,'SAM','Dimensions',{'N_use',NN});
